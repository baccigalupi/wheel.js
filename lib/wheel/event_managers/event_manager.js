...
Wheel.EventManager = Wheel.View.subclass({
  ...
  onDragStart: function(event) {
    ...
    var self = this;
    this.target.on(this.moveEvent, function(e) {
      e.preventDefault();
      self.onDragMove(e);
    });

    this.target.on(this.endEvent, function(e) {
      e.preventDefault();
      self.onDragEnd(e);
    });
  },
  ...
  onDragEnd: function(e) {
    ...
    // TODO: this will remove too much handlering on the element!!!
    this.target.off(this.moveEvent + ' ' + this.endEvent);
  },
