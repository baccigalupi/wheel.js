...
Wheel.Utils.StorageFill = Wheel.Class({
  init: function(name) {
    this.name = name;
    this._reset();
    this.deserialize();
...
!window.localStorage &&   (window.localStorage =   new Wheel.Utils.CookieStorage('localStorage'));
!window.sessionStorage && (window.sessionStorage = new Wheel.Utils.StorageFill('sessionStorage'));
